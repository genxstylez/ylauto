# Django settings for ylauto project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(ROOT_PATH, 'web.db'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '^9po9g%t53#i=h#@l#jk$0y!ob%81b2np516@+84=bufsz_kcf'
...
WSGI_APPLICATION = 'ylauto.wsgi.application'
